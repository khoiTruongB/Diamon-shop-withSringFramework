...
(1, 'carousel3.png', 'Hình 1', 'Very easy to integrate and expand.'),
(2, 'bootstrappage_shop.png', 'Hình 2', 'Compitable to many more opensource cart'),
(3, 'bootstrap-templates.png', 'Hình 3', 'Very clean simple to use'),
(5, 'carousel1.png', 'Hình 4', 'Highly Google seo friendly');
